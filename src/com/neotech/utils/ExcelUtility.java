...
public class ExcelUtility  {
	...
	/**
	 * This method return column count for a given row index in the current sheet.
	 * @param rowIndex
	 * @return
	 */
	...
	public static Object [][] excelIntoArray(String filePath,String sheetName)
	{
		...
		loadSheet(sheetName);
		// define/get the number of rows
		
		int rowNumber =	rowCount();
		
		// define/get the number of columns
